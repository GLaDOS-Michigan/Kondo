...
module DistributedSystem {
  ...
  datatype Constants = Constants(p1Quorum: nat, p2Quorum: nat, n: nat, leaders: seq<LeaderHost.Constants>, acceptors: seq<AcceptorHost.Constants>, learners: seq<LearnerHost.Constants>) {
    ghost predicate WF()
      decreases this
    {
